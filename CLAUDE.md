...
4. Add direct technical integrations as active items. Explain the Neo4j role, partner role, and joint result in the summary. Add useful future candidates as watch items. Keep thin pages, duplicates, and index pages as excluded items when that decision prevents repeat work.
